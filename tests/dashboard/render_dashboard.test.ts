...
import render_dashboard, {
	...
	render_forms,
	render_metrics,
} from "../../src/dashboard/render_dashboard.js";
...
test("render_metrics adds htmx polling attributes", () => {
	...
	const html = render_metrics(sample, {
...
test("render_dashboard composes sections", () => {
	const sample = makeState({
		...
		channels: [{ id: "111", name: "alpha", count24h: 1, count7d: 10 }],
		errors: ["Boom", "Kapow"],
	});
	const html = render_dashboard(sample, {
		canonicalBaseUrl: "https://example.com",
