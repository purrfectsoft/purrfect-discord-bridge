...
Built originally for the **Purrfect Universe**, it is now released by **Purrfect Software Limited** to help any remote-first or async-heavy team maintain context, alignment, and clarity.
...
| 🧩 **Extensible** | Each subsystem (storage, redact, summarizer, dashboard) is modular. |
...
- **discord.js v14**  
- **OpenAI API v4**  
- **cron + luxon** for scheduling and time-zone safety  
- **Pure HTTP (no Express)** for webhooks and dashboard  
...
* ✅ `npm start` → bot online → dashboard accessible
...
© 2025 [Purrfect Software Limited](https://purrfectsoft.com)
